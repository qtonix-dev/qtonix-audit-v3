...
const EMAIL_CATALOG = [
  ...
  { id: 'survey_launch', name: 'Survey launch', category: 'hr', description: 'Sent when a new survey is activated, asking the team to complete it.', sentTo: 'All agents & managers', logTypes: ['survey_launch'] },
  { id: 'survey_done', name: 'Survey completion thank-you', category: 'hr', description: 'Sent to an agent right after they submit a survey response.', sentTo: 'The responding agent', logTypes: ['survey_done'] },
  // ===== HR / Recruitment / Onboarding emails =====
  { id: 'hr_application_thankyou', name: 'Application received (candidate)', category: 'hr', description: 'Sent to a candidate confirming their job application was received.', sentTo: 'Applicant', logTypes: ['hr_application_thankyou'] },
  { id: 'hr_application_notice', name: 'New application (internal)', category: 'hr', description: 'Internal notice to the recruitment inbox when a new application arrives.', sentTo: 'Recruitment mailbox', logTypes: ['hr_application_notice'] },
  { id: 'hr_shortlisted', name: 'Candidate shortlisted', category: 'hr', description: 'Sent to a candidate when their resume is shortlisted for a role.', sentTo: 'Candidate', logTypes: ['hr_shortlisted'] },
  { id: 'hr_recruiter_reply', name: 'Recruiter reply / compose', category: 'hr', description: 'A direct email a recruiter sends to a candidate from the recruitment mailbox.', sentTo: 'Candidate', logTypes: ['hr_recruiter_reply'] },
  { id: 'hr_reject_or_custom', name: 'Rejection / custom candidate email', category: 'hr', description: 'A rejection or custom email sent to a candidate from the candidate page.', sentTo: 'Candidate', logTypes: ['hr_reject_or_custom'] },
  { id: 'hr_interview_invite', name: 'Interview invitation', category: 'hr', description: 'Sent to a candidate (and panel) when an interview is scheduled, with a calendar invite.', sentTo: 'Candidate & interview panel', logTypes: ['hr_interview_invite'] },
  { id: 'hr_interview_reschedule', name: 'Interview rescheduled', category: 'hr', description: 'Sent when an interview time is changed, with the updated calendar invite.', sentTo: 'Candidate & interview panel', logTypes: ['hr_interview_reschedule'] },
  { id: 'hr_task_assignment', name: 'Assessment task assigned', category: 'hr', description: 'Sent to a candidate with an assessment task to complete.', sentTo: 'Candidate', logTypes: ['hr_task_assignment'] },
  { id: 'hr_task_updated', name: 'Assessment task updated', category: 'hr', description: 'Sent when an assessment task’s details are corrected and re-shared.', sentTo: 'Candidate', logTypes: ['hr_task_updated'] },
  { id: 'hr_task_reactivate', name: 'Assessment task link reactivated', category: 'hr', description: 'Sent when a candidate’s task upload link is reactivated.', sentTo: 'Candidate', logTypes: ['hr_task_reactivate'] },
  { id: 'hr_task_addinfo', name: 'Additional information requested', category: 'hr', description: 'Sent to a candidate asking for more information on their task.', sentTo: 'Candidate', logTypes: ['hr_task_addinfo'] },
  { id: 'hr_task_received', name: 'Task submission received', category: 'hr', description: 'Sent to a candidate confirming their assessment task submission was received.', sentTo: 'Candidate', logTypes: ['hr_task_received'] },
  { id: 'onboarding_received', name: 'Onboarding documents received', category: 'hr', description: 'Sent to a new joiner confirming their onboarding submission was received.', sentTo: 'New joiner', logTypes: ['onboarding_received'] },
  { id: 'onboarding_welcome', name: 'Onboarding welcome & next steps', category: 'hr', description: 'Sent to a hired candidate with the onboarding link and next steps.', sentTo: 'New joiner', logTypes: ['onboarding_welcome'] },
  { id: 'onboarding_welcome_aboard', name: 'Welcome aboard', category: 'hr', description: 'The final welcome-aboard email sent to a new joiner.', sentTo: 'New joiner', logTypes: ['onboarding_welcome_aboard'] },
  { id: 'onboarding_query_reply', name: 'Onboarding question reply', category: 'hr', description: 'Sent to a candidate answering a question they asked from their onboarding page.', sentTo: 'New joiner', logTypes: ['onboarding_query_reply'] },
  { id: 'onboarding_kpi_kra', name: 'KPI & KRA email', category: 'hr', description: 'Sent to a new joiner with their key result areas and performance indicators.', sentTo: 'New joiner', logTypes: ['onboarding_kpi_kra'] },
  { id: 'onboarding_reminder', name: 'Onboarding reminder', category: 'hr', description: 'Automated reminder to a joiner who hasn’t completed onboarding yet.', sentTo: 'New joiner', logTypes: ['onboarding_reminder'] },
  { id: 'onboarding_senior', name: 'New joiner notice (managers)', category: 'hr', description: 'Automated heads-up to managers/TLs about an upcoming new joiner.', sentTo: 'Department managers & TLs', logTypes: ['onboarding_senior'] },
  { id: 'onboarding_reporting', name: 'First-day reporting details', category: 'hr', description: 'Automated email to a joiner with where and when to report on day one.', sentTo: 'New joiner', logTypes: ['onboarding_reporting'] },
];
